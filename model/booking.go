...
type Booking struct {
	...
	WorkspaceRequired int16  `json:"workspace_required"`
	UserIds           []int
...
func (b *Booking) InsertBooking() error {
	dt := time.Now()
	query := "INSERT INTO bookings (city_id, location_id, building_id, floor_id, from_date, to_date, purpose, user_id, workspace_required, created_at, updated_at)" +
	...
	d := migration.DbPool.QueryRow(
		...
		b.Purpose, b.UserId, b.WorkspaceRequired, dt, dt,
	)
